...
public class TypeNewAdapter extends BaseQuickAdapter<TypeBean, BaseViewHolder> {
    private int checked;
    ...
    public TypeNewAdapter(Context mContext, @Nullable List<TypeBean> data) {
    ...
    protected void convert(BaseViewHolder helper, TypeBean item) {
        ...
        if (TextUtils.equals(item.getName(), "折扣")) {
            ...
            ((TextView) helper.getView(R.id.tv_name)).setCompoundDrawablesWithIntrinsicBounds(null, null, null, null);
        }
