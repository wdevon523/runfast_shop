 ...
 */
public class MoneyExpenditureFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_money_expenditure, container, false);
            ...
            if (mRecords != null) {
                if (mRecords.getRows() != null && mRecords.getRows().size()>0) {
                    ...
                    for (int i = 0; i < size; i++) {
                        if (mRecords.getRows().get(i).getShowtype()==1){
