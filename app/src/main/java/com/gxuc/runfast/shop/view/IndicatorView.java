...
public class IndicatorView extends View {
    ...
    public IndicatorView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            indicatorWidth = DeviceUtil.dip2px(context, typedArray.getInt(R.styleable.IndicatorView_indicatorWidth, 0));
            gravity = typedArray.getInt(R.styleable.IndicatorView_indicatorGravity, 0);
            typedArray.recycle();
        }
    }
