...
public class AddButton extends View implements View.OnClickListener {
	...
	private void initPaint() {
		...
		paint.setColor(ContextCompat.getColor(getContext(), R.color.bg_fba42a));
	...
	protected void onDraw(Canvas canvas) {
		...
		} else if (getWidth() == getContext().getResources().getDimension(R.dimen.dimen_22_dp)) {
			drawText(canvas);
		}
	}
	...
	public void expendAnim() {
		isCircle = false;
		ViewAnimator.animate(this)
				.width(getWidth(), getContext().getResources().getDimension(R.dimen.dimen_75_dp))
				.duration(300)
				.onStop(new AnimationListener.Stop() {
					@Override
					public void onStop() {
